    ...
    <section className="w-full text-white py-20 px-6 lg:px-15 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-8">
        {universeData.map((item, index) => (
          <div
            key={index}
            className="rounded-3xl bg-[#101426]/80 border border-[#ffffff14] p-6 flex flex-col transition-all duration-300 hover:border-cyan-500/40 hover:shadow-[0_0_30px_rgba(0,229,255,0.12)] hover:-translate-y-1 group"
          >
            ...
            <Link
              href={item.linkHref}
              className="self-start inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-[#ffffff08] border border-[#ffffff1a] text-cyan-400 text-xs font-semibold transition-all duration-300 hover:bg-cyan-500/10 hover:border-cyan-400 hover:shadow-[0_0_15px_rgba(0,229,255,0.3)]"
            >
