          ...
          <div className="md:col-span-4 space-y-5">
            ...
            <div className="flex items-center gap-3.5 pt-1">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-11 h-11 rounded-2xl bg-[#0d1527] border border-slate-800/80 flex items-center justify-center text-slate-300 transition-all duration-300 hover:bg-[#0A66C2] hover:text-white hover:-translate-y-2 hover:-rotate-6 hover:scale-105 hover:shadow-[0_0_22px_rgba(201,168,106,0.7)]"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
